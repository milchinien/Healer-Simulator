...
Das Spiel (Spielbeschreibung: `../GAME_DESIGN.md`, Inhalte: `../inhalte/`). Enthält bisher Titel, Charakterauswahl, Charaktererstellung, Optionen und Ladebildschirm; als Nächstes folgt der Hauptbildschirm mit dem Kampf in Grünhain.
...
| **Ladebildschirm** | Grünhain, Fortschrittsbalken, Tipps. ESC führt zurück (die Welt ist noch im Bau). |
